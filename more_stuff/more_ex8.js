// Exercise 8 from intro to programming with JS
...
function checkNan(value) {
  if (Math.sign(value) !== 1 && Math.sign(value) !== 0 && Math.sign(value) !== -0 && Math.sign(value) !== -1) {
    return true;
  } else {
    return false;
  }
}
console.log(checkNan(747.837));
console.log(checkNan(21));
console.log(checkNan(0));
console.log(checkNan(-0));
console.log(checkNan(-27));
console.log(checkNan(-83.372));
